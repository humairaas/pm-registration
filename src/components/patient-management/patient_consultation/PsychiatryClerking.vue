<template>
  <div class="template">
    <div class="header" style="margin-bottom: 4rem; margin-top: 1rem;">
      ...
      <span contenteditable @keydown="preventLineBreaks">Psychiatry Clerking Note</span>
      </h2>
    ...
    <div class="hide-in-print">
      This is Psychiatric Clerking Note template. This will hide in print.
    </div>
    ...
    <table style="margin-top: 10px;" class="order-table">
      ...
      <tbody>
        ...
        <tr>
          <td><div v-if="items.length < 5" class="left-btn hide-in-print" @click="() => items.push({ key: Math.random(), ref: 'MyRef', desc: 'Enter Other Diagnosis', qty: 1, price: 0 })">➕</div></td>          
        </tr>
