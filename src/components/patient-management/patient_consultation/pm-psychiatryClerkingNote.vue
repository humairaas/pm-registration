...
export default {
  data () {
    return {
      ...
      model: {
        ...
        TITLE: 'PSYCHIATRY CLERKING NOTE',
        DIAGNOSIS_TYPE: '',
        SERVICE_CATEGORY: '',
        SERVICE_COMPLEXITY: '',
        SERVICES: '',
        ...
        groups: [
          {
            fields: [
              ...
              },
              {
                ...
                model: 'PRESENTING_ILLNESS_HISTORY',
                placeholder: 'Enter Description',
                rows: 3,
                required: true,
                validator: 'string',
              ...
              },
              {
                ...
                model: 'MENTAL_STATE_EXAMINATION',
                placeholder: 'Enter Description',
                rows: 3,
                required: true,
                validator: 'string',
  ...
  mounted () {
    ...
    this.$axios
      .get('http://127.0.0.1:8000/api/getPsychiatryClerkingNoteMountedData?patient_id=' + patientId)
      .then((response) => {
