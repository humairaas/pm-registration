  ...
  routes: [
    ...
    // Patient Management
    {
      ...
      },
      {
        ...
        path: 'patient-appointment-record',
        component: () =>
          import('../components/patient-management/patient_appointment/pm-appointmentRecord.vue'),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import('../components/patient-management/patient_consultation/clinical_information.vue'),
      },
      {
